...
SECRET_KEY = 'django-insecure-9_q#1t0^ok#wop@^(n1vum=mr05lkpfwmhui)4i_)03k2$ienn'
...
LOGIN_REDIRECT_URL = 'default_chat'  # Redirect to the default_chat view after login
